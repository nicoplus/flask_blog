...
class UserModelTestCase(unittest.TestCase):
	...
	def test_roles_and_permissions(self):
		Role.insert_roles()
		u = User(email='john@exmaple.com', password='cat')
	...
	def test_timestamp(self):
		...
		self.assertFalse(datetime.now() == u.member_since)
		self.assertFalse(datetime.now() == u.last_seen)
	...
	def test_follows(self):
		...
		self.assertTrue(f.follower == u1 or f.follower==u2)
 		u1.unfollow(u2)
		db.session.add(u1)
		db.session.commit()
